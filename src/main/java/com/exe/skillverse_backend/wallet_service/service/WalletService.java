...
public interface WalletService {
    ...
    WalletTransaction addCoins(Long userId, Long coinAmount, WalletTransaction.TransactionType transactionType, String description, String referenceType, String referenceId);
    WalletTransaction deductCoins(Long userId, Long coinAmount, WalletTransaction.TransactionType transactionType, String description, String referenceType, String referenceId);
    ...
    CreatePaymentResponse createDepositPayment(Long userId, BigDecimal amount, String paymentMethod, String returnUrl, String cancelUrl);
    Map<String, Object> getGlobalStatistics();
    Map<String, Object> getDailyStatistics(String startDate, String endDate);
    WalletTransaction deductCash(Long userId, BigDecimal cashAmount, String description, String referenceType, String referenceId);

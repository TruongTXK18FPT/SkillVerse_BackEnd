...
public class AuthServiceImpl implements AuthService {
        ...
        public RegistrationResponse verifyEmailAndActivate(String email, String otp) {
                try {
                        ...
                        String actionType = (user.getPrimaryRole() == PrimaryRole.USER) 
        ...
        public AuthResponse authenticateWithGoogle(String idToken, Boolean rememberMe) {
                try {
                        ...
                        if (existingUser.isEmpty()) {
                                ...
                                // ✅ Auto-assign FREE_TIER subscription to new Google user using PremiumService
                                try {
                                        premiumService.assignFreeTierIfMissing(user.getId());
                                        log.info("✅ Auto-assigned FREE_TIER subscription to Google user: {}", email);
                                } catch (Exception e) {

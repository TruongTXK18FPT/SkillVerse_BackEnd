...
public class ValidGitHubUrlValidator implements ConstraintValidator<ValidGitHubUrl, String> {
    @Override
    public boolean isValid(String url, ConstraintValidatorContext context) {
        ...
        try {
            ...
            if (!parsed.getHost().contains("github.com")) {
                context.disableDefaultConstraintViolation();
                context.buildConstraintViolationWithTemplate("URL GitHub không hợp lệ. Vui lòng nhập URL từ github.com").addConstraintViolation();
                return false;
            }

...
public class SupportTicketController {
         ...
         */
        @PostMapping("/tickets")
        @Operation(summary = "Create ticket", description = "Create a new support ticket. No authentication required.")
        ...
        @Operation(summary = "Get ticket by code", description = "Get ticket details by ticket code for tracking")
        ...
        @Operation(summary = "Get tickets by email", description = "Get all tickets submitted with a specific email")
        ...
        @Operation(summary = "Get my tickets", description = "Get all tickets for the authenticated user")
        ...
        @PreAuthorize("isAuthenticated()")
        @Operation(summary = "Add response", description = "Add a follow-up response to an existing ticket")
        ...
        @PreAuthorize("isAuthenticated()")
        @Operation(summary = "Close ticket", description = "Close a ticket. Only the ticket owner can close it.")
    ...
    public ResponseEntity<TicketStatsResponse> getTicketStats() {
        ...
        @Operation(summary = "Delete ticket (Admin)", description = "Delete a ticket permanently")
